...
function draw() {
  ...
  judul = createElement('h3', 'Nama : Ramanda Ditra Kristian')
  judul.position(50, 60)
  judul = createElement('h3', 'NIM : 122160042')
...
class Mover {
  ...
  display(){
    noStroke();
    fill(255,0,0);
    rect(this.location.x, this.location.y, 2*this.mass, 2*this.mass);
 }
  applyForce(force){
    force.div(this.mass)
